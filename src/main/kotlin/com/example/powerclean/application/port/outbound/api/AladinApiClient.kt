...
interface AladinApiClient {
    ...
    /** 키워드로 도서 검색 */
    fun searchBooks(query: String, maxResults: Int = 20, start: Int = 1): AladinSearchResult

    /** 베스트셀러 목록 조회 */
    fun getBestSellers(categoryId: Int = 0, maxResults: Int = 50): AladinSearchResult

    /** 신간 목록 조회 */
    fun getNewBooks(categoryId: Int = 0, maxResults: Int = 50): AladinSearchResult

    /** 주목할만한 신간 조회 */
    fun getNewSpecialBooks(categoryId: Int = 0, maxResults: Int = 50): AladinSearchResult
